...
from flask_app.behavior_collector import _collect_probs, _get_arithmetic_average
...
class TestInnerMethod(MyTestCase):
    ...
    def test_collect_probs(self):
        ...
        self.assertAlmostEqual(result, _collect_probs(cur_prob_list, other_prob_list, k_weight))
